// Based on original example in MicroDexed distribution file MicroDexed/third-party/Synth_Dexed
...
void setup()
{
  ...
  dexed.decodeVoice(decoded_voice, sitar);
...
//    Serial.println("Init Voice");
    ...
    dexed.setTranspose(0);
    Serial.println("decoded_voice");
  }
  else
  {
      dexed.loadVoiceParameters(fmpiano_sysex);
      dexed.setTranspose(36);
      Serial.println("fmpiano_sysex");
//    dexed.loadVoiceParameters(fmpiano_sysex);
//    dexed.setTranspose(36);
//    Serial.println("fmpiano_sysex");
  }
